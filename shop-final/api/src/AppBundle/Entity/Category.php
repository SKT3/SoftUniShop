...
class Category
{
   ...
   private $products;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="DiscountCategory")
     ...
     * Add discount
     *
     * @param \AppBundle\Entity\DiscountCategory $discount
     *
     * @return Category
     */
    public function addDiscount(\AppBundle\Entity\DiscountCategory $discount)
    {
     ...
     * @param \AppBundle\Entity\DiscountCategory $discount
     */
    public function removeDiscount(\AppBundle\Entity\DiscountCategory $discount)
    {
